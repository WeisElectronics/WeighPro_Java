...
public static final int menuPanelXBound = 50;//x bound for the menu panel
public static final int menuPanelYBound = 50;//y bound for the menu panel

public static final int systemFunctionsPanelXBound = 50;//x bound for the system function panel
public static final int systemFunctionsPanelYBound = 475;//y bound for the system function panel

public static final int logoXBound = 80;//x bound for the logo
