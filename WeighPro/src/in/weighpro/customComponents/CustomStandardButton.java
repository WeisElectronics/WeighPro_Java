/* This class provides the pluggable button component
...
public class CustomStandardButton extends AbstractButton {
	...
	public CustomStandardButton(String buttonText) {
	...
	public void paintComponent(Graphics g) {
		...
		g2.setColor(new Color(0, 0, 0, 100));//Grey color for the button when it is not clicked
